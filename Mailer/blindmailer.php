 ...
 * Reply-To is used as bounce address (Return-Path) when provided
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'send') {
    ...
    foreach ($valid_emails as $email) {
        ...
        try {
            ...
            // ─── Dynamic bounce address ───
            $bounce_address = !empty($reply_to) && filter_var($reply_to, FILTER_VALIDATE_EMAIL)
                ? $reply_to
                : 'bounces@jmmiles.com';  // ← CHANGE THIS to your real monitored bounce address

            $mail->Sender = $bounce_address;  // Return-Path / envelope sender for bounces
        ...
        <div class="card">
            ...
            <div class="card-body p-3">
                <form method="post" enctype="multipart/form-data" id="mailerForm" onsubmit="return validateForm()">
                    ...
                    <div class="tight-mb">
                        <label class="form-label">Reply-To (optional – also used for bounces)</label>
                        ...
                        <div class="form-text small text-muted mt-1">Bounces & undeliverable notices will go here if provided.</div>
